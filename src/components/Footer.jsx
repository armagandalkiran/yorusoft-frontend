...
const PlanContainer = styled.div`
  ...
  background: linear-gradient(
    90deg,
    rgba(86, 104, 209, 0.85) 0%,
    rgba(30, 165, 252, 0.84) 100%
  );
  border-radius: 10px;
`;
    ...
    <Container>
      <Wrapper>
        ...
        <FooterContents>
          <PlanContainer>
            <PlanTitle>
              Switch to Premium Plan today and save up to 30% off
            </PlanTitle>
            <PlanDesc>
              Check which versions are available to upgrade to and validate
              whether your current subcription is upgradeable
            </PlanDesc>
            <PlanImageContainer>
        ...
        <ReserveContainer>
          © Copyright 2020 by yorusoft. All rights reserved
        </ReserveContainer>
      </Wrapper>
    </Container>
  );
